    ...
    return (
        ...
        <View style={{flex:1,backgroundColor:colors.primary,padding:20,alignItems:'center'}}>
           <LogoContainer/>
            ...
            <View style={{marginTop:30,marginBottom:1,flexDirection:'row',justifyContent:'center',width:'100%',alignItems:'center'}}>
              <View style={{flex:2,alignItems:'flex-end',paddingLeft:9}}><Text style={{marginBottom:15,fontSize:14,fontWeight:'700'}}>Or Login using social media</Text></View>
              <View style={{flex:1,alignItems:'flex-end',paddingRight:10}}><Icon name="google" color={colors.primary} size={30}/></View>
            </View>
                </View>
