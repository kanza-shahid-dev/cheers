...
const Profile = (props) => {
    ...
    return (
        <ScrollView contentContainerStyle={{flexGrow:1}}>
            ...
            <HeadingComp title="Profile" right={<ButtonComp title="ORDER HISTORY" type="normal-circle" onPress={()=>props.navigation.navigate("OrderHistory")}/>}/>
            ...
            <InputComp label="User Id"  icon="user-alt" error={userIdError} keyboardType="number-pad" onChangeText={(value)=>validateUserId(value)}/>
            ...
            <ButtonComp title="UPDATE" type="circle" onPress={()=>props.navigation.navigate("AccountCreated")}/>
            </View>
